...
MERGE_MODES = {
    ...
    "sophisticated": {
        ...
        "description": "A sophisticated merge which allows you to use "
                       "advanced options for merging files.",
        "image": "static/sophisticated_merge.png"
    },
    "filter": {
        "title": "Filtering & sorting",
        "name": "filtering & sorting",
        "description": "Apply simple or sophisticated filtering "
                       "and sorting algorithms to a single or multiple files.",
...
SOPHISTICATED_MERGE_MODES = {
    "mode1": {
        ...
        "description":
            ...
            "If there are multiple files you can choose if you want to save all "
            "in one file or different.",
        "image": "static/sophisticated_merge.png",
    ...
    "mode2": {
        ...
        "description":
            "This mode provides functionality to choose one or multiple columns "
            "and to find all columns "
    ...
    "mode3": {
        ...
        "description":
            "This mode provides functionality to choose all columns "
            "which name contains a word/number of the list.",
        "image": "static/sophisticated_merge.png",
...
FILTER_MODES = {
    "mode1": {
        ...
        "description":
            "This mode provides functionality to choose all columns/lines "
            "which contain a word/collocation of the list.",
        "image": "static/sophisticated_merge.png",
